...
'''We are importing modules in middle of the files for the better understanding 
but me need to import all the modules in the beginning of the file  '''
...
print("Random integer between 1 and 10:",
      random.randint(1, 10))  # Output:  Selects a random integer between 1 and  10, inclusive.

# Using randrange to get a random integer within a specified range
print("Random integer from range 1 to 10:",
      random.randrange(1, 10))  # Output: Generates a random integer between 1 and 9 (10 is exclusive)
