...
# It is a core concept of OOP that allows a function or method to operate on objects of different types.
# Eg: Method overloading, method overriding, and duck typing.
# Note: Python does not support method overloading in the traditional sense (like in Java), but we can achieve similar behavior.
