...
# add() inserts a single element into the set.(It's like append in the list)
s.add(8)
print(s)  # Output: {2, 3, 4, 5, 7, 8}

# update() inserts elements from an iterable (e.g., list, set) into the set.(It is like extend in the list)
s.update([30, 50, 70])
